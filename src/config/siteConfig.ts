...
export const siteConfig: SiteConfig = withUserConfig("site", {
	site: "https://teaclearinkii.pages.dev/",
	base: "/",
	title: "茶清墨刂",
	subtitle: "个人网站",
	...
	banner: {
		...
		src: {
			desktop: ["/assets/desktop-banner/1.png", "/assets/desktop-banner/2.png", "/assets/desktop-banner/3.png"],
			mobile: ["/assets/mobile-banner/1.png", "/assets/mobile-banner/2.png"],
		},
