...
export const siteConfig: SiteConfig = {
  title: "茶清墨刂",
  subtitle: "个人网站",
  siteURL: "https://teaclearinkii.pages.dev/", // 请替换为你的站点URL，以斜杠结尾
  siteStartDate: "2026-08-30", // 站点开始运行日期，用于站点统计组件计算运行天数
  ...
  navbarTitle: {
    ...
    icon: "assets/home/TeaClearInkII.webp",
    // 网站Logo图片路径
    logo: "assets/home/TeaClearInkII.webp",
  },
  ...
  bilibili: {
    vmid: "388428308", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
