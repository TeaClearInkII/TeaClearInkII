...
<div style="display: flex; gap: 32px; align-items: flex-start; flex-wrap: wrap; justify-content: center;">
    <div style="text-align: center;">
        ...
        <img src="/assets/images/茶清墨刂微信收款码.png" alt="微信收款码" style="height: 300px; width: auto; border-radius: 8px;">
    </div>
    <div style="text-align: center;">
        <p style="margin-bottom: 8px; font-weight: bold;">支付宝收款码：</p>
        <img src="/assets/images/茶清墨刂支付宝收款码.jpg" alt="支付宝收款码" style="height: 300px; width: auto; border-radius: 8px;">
    </div>
</div>
